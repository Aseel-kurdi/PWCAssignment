...
public class ComplaintService {
    ...
    // to store the complaint info which is taken from the client in the database
...
// this function brings all the complaints submitted by the client who logged in from the data base
   ...
   // this function to return all complaints with new status to to be displayed on the Admin page
   ...
   // after the admin choose the proper status it will be stored in th database
